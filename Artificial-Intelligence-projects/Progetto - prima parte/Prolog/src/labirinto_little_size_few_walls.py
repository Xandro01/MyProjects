...
if(choice == "Opzione 1" or choice == "Opzione 2"):
    prolog.consult(base_strategy_path + "knowledge_little_size_few_walls.pl")
    if(choice == "Opzione 1"):
...
if(choice == "Opzione 3" or choice == "Opzione 4"):
    prolog.consult(final_strategy_path + "knowledge_little_size_few_walls.pl")
...
prolog.assertz(":-[knowledge_little_size_few_walls]")
